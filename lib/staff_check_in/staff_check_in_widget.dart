...
import '/components/modal_staff_check_in_widget.dart';
...
import 'staff_check_in_model.dart';
export 'staff_check_in_model.dart';

class StaffCheckInWidget extends StatefulWidget {
  const StaffCheckInWidget({
    super.key,
    bool? isEvento,
  ...
  @override
  State<StaffCheckInWidget> createState() => _StaffCheckInWidgetState();
}

class _StaffCheckInWidgetState extends State<StaffCheckInWidget> {
  late StaffCheckInModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StaffCheckInModel());
  }
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Builder(
                              builder: (context) {
                                final listarEventos =
                                    ListarEventosCall.dadosListarEventos(
                ...
                if (widget.isEvento)
                  Expanded(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(),
                      child: FutureBuilder<ApiCallResponse>(
                        future: ListarStaffsEventImerCall.call(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewListarStaffsEventImerResponse =
                              snapshot.data!;
                          return Builder(
                            builder: (context) {
                              final listarEventosStaff =
                                  ListarStaffsEventImerCall.dados(
                                        listViewListarStaffsEventImerResponse
                                            .jsonBody,
                                      )?.toList() ??
                                      [];
                              return ListView.builder(
                                ...
                                itemBuilder:
                                    (context, listarEventosStaffIndex) {
                                  final listarEventosStaffItem =
                                      listarEventosStaff[
                                          listarEventosStaffIndex];
                                  return Wrap(
                                    spacing: 0.0,
                                    runSpacing: 0.0,
                                    alignment: WrapAlignment.start,
                                                                  ...
                                                                  child: custom_widgets
                                                                    ...
                                                                    base64Image:
                                                                      ...
                                                                      getJsonField(
                                                                              ...
                                                                              null
                                                                          ? functions
                                                                              .base64ComBarraInvertida(getJsonField(
                                                                              listarEventosStaffItem,
                                                                              r'''$.banner''',
                                                                            ).toString())
                                                                          : '',
