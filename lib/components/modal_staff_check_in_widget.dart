...
import 'modal_staff_check_in_model.dart';
export 'modal_staff_check_in_model.dart';

class ModalStaffCheckInWidget extends StatefulWidget {
  const ModalStaffCheckInWidget({
    super.key,
  ...
  @override
  State<ModalStaffCheckInWidget> createState() =>
      _ModalStaffCheckInWidgetState();
}

class _ModalStaffCheckInWidgetState extends State<ModalStaffCheckInWidget> {
  late ModalStaffCheckInModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalStaffCheckInModel());
  }
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (confirmDialogResponse) {
                                  _model.cadastraEventoStaffRetorno =
                                      await ApkCadastraStaffEventoCall.call(
                                    pesLogin: FFAppState().pesLogin,
                                    eventId: widget.idEvento,
                                    eventOuImer: widget.evenOuImer,
                                  );
