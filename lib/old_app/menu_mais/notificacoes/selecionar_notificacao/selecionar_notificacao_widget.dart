...
class _SelecionarNotificacaoWidgetState
    extends State<SelecionarNotificacaoWidget> {
  late SelecionarNotificacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelecionarNotificacaoModel());
  }
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: Switch.adaptive(
                                              value: _model.switchzapValue ??=
                                                  false,
                                              onChanged: (newValue) async {
                                                setState(() =>
                                                    _model.switchzapValue =
                                                        newValue!);
                                              },
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Align(
                                              ...
                                              child: Switch.adaptive(
                                                value: _model
                                                    .switchpushValue ??= false,
                                                onChanged: (newValue) async {
                                                  setState(() =>
                                                      _model.switchpushValue =
                                                          newValue!);
                                                  if (newValue!) {
                                                    await showDialog(
                                                      context: context,
