...
class _AlterarSenhaWidgetState extends State<AlterarSenhaWidget> {
  ...
  void initState() {
    ...
    _model.senhaatuallController ??= TextEditingController();
    _model.senhaatuallFocusNode ??= FocusNode();

    _model.novasenhaController ??= TextEditingController();
    _model.novasenhaFocusNode ??= FocusNode();

    _model.confirmanovasenhaController ??= TextEditingController();
    _model.confirmanovasenhaFocusNode ??= FocusNode();
  }
                                        ...
                                        children: [
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .senhaatuallController,
                                                focusNode:
                                                    _model.senhaatuallFocusNode,
                                                autofocus: true,
                                                obscureText: !_model
                                                    .senhaatuallVisibility,
                                                ...
                                                validator: _model
                                                    .senhaatuallControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
                                        ...
                                        children: [
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .confirmanovasenhaController,
                                                focusNode: _model
                                                    .confirmanovasenhaFocusNode,
                                                obscureText: !_model
                                                    .confirmanovasenhaVisibility,
                                                decoration: InputDecoration(
                                                  hintText:
                                                  ...
                                                  suffixIcon: InkWell(
                                                    ...
                                                    focusNode: FocusNode(
                                                        skipTraversal: true),
                                                    child: Icon(
                                                      _model.confirmanovasenhaVisibility
                                                          ? Icons
                                                              .visibility_outlined
                                                          : Icons
                                                              .visibility_off_outlined,
                                                ...
                                                validator: _model
                                                    .confirmanovasenhaControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
                                      ...
                                      children: [
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            if ((_model.senhaatuallController
                                                            .text !=
                                                        null &&
                                                    _model.senhaatuallController
                                                            .text !=
                                                        '') &&
                                                (_model.novasenhaController
                                                            .text !=
                                                    ...
                                                    _model.novasenhaController
                                                            .text !=
                                                        '') &&
                                                (_model.confirmanovasenhaController
                                                            .text !=
                                                        null &&
                                                    _model.confirmanovasenhaController
                                                            .text !=
                                                        '')) {
                                              if (_model.novasenhaController
                                                      .text ==
                                                  _model
                                                      .confirmanovasenhaController
                                                      .text) {
