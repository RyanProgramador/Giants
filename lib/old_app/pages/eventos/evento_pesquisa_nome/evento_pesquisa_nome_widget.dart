...
class _EventoPesquisaNomeWidgetState extends State<EventoPesquisaNomeWidget>
    with TickerProviderStateMixin {
  late EventoPesquisaNomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventoPesquisaNomeModel());
