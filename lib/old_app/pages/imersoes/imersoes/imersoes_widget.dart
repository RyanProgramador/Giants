...
class ImersoesWidget extends StatefulWidget {
  const ImersoesWidget({Key? key}) : super(key: key);

  @override
  _ImersoesWidgetState createState() => _ImersoesWidgetState();
}

class _ImersoesWidgetState extends State<ImersoesWidget> {
  late ImersoesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImersoesModel());
                ...
                child: Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewListarEventosResponse = snapshot.data!;
                      return Builder(
                        builder: (context) {
                          final listarEventos =
                              ListarEventosCall.dadosListarEventos(
                                    listViewListarEventosResponse.jsonBody,
                                  )?.toList() ??
                                  [];
